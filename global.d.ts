...
// FIX: Wrap declarations in `declare global` to make them available globally
// from this module file, and augment the Window interface.
declare global {
  interface Window {
    google: typeof google;
  }

  // Add process.env types for the execution environment
  namespace NodeJS {
    interface ProcessEnv {
      // Key for Gemini API, provided by the execution environment
